...
public struct VocabularyNotebookView: View {
    ...
    private func wordHeaderView(item: SavedWordItem) -> some View {
        HStack(alignment: .top) {
            VStack(alignment: .leading, spacing: 6) {
                ...
                // Badges (Only for normal vocabulary)
                if !item.isGrammarFormula {
                    HStack(spacing: 6) {
    ...
    // MARK: - Dedicated Grammar Structure & Formula Detail View
    @ViewBuilder
    private func grammarDetailView(item: SavedWordItem) -> some View {
    ...
    private func originalContentSection(item: SavedWordItem) -> some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            // 3. Offline Dictionary API Definitions
